...
contract CryptoCollectiblesMarket {
    ...
    mapping(bytes32 => uint256) tokenPrices;
    uint256 public minMintPrice;
    uint256 public mintFeeBps;
    uint256 public feeCollected;

    constructor(CryptoCollectibles cryptoCollectibles_, uint256 minMintPrice_, uint256 mintFeeBps_) {
    ...
    function mintCollectibleFor(address who) public payable returns (bytes32) {
        ...
        uint256 mintPrice = sentValue * 10000 / (10000 + mintFeeBps);
