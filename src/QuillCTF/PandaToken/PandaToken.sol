...
contract PandaToken is ERC20, Ownable {
    ...
    constructor(uint256 _c1, string memory tokenName, string memory tokenSymbol) ERC20(tokenName, tokenSymbol) {
        assembly {
            let ptr := mload(0x40)
    ...
    function calculateAmount(uint256 I1ILLI1L1ILLIL1LLI1IL1IL1IL1L) public view returns (uint256) {
        uint256 I1I1LI111IL1IL1LLI1IL1IL11L1L;
        assembly {
    ...
    function getTokens(uint256 amount, bytes memory signature) external {
        uint256 giftAmount = calculateAmount(amount);
